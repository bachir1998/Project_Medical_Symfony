...
/* user/show.html.twig */
class __TwigTemplate_2d1c9ae076fd52dadc57c0a5fa60c9d07e3f157bf31ced954de84137e398032d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("espace_personnel/layout.html.twig", "user/show.html.twig", 1);
    ...
    <a class=\"btn btn-warning\"  href=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 32, $this->source); })()), "id", [], "any", false, false, false, 32)]), "html", null, true);
        echo "\">edit</a><br/>
    <br/>
...
";
    ...
    {
        return array (  142 => 35,  136 => 32,  131 => 30,  123 => 25,  116 => 21,  109 => 17,  102 => 13,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
  <div class=\"container\" style=\"width: 70%;margin-top:50px\">
    <h1>User : {{user.prenom}} {{user.nom}}</h1>
    ...
    <a class=\"btn btn-dark\" href=\"{{ path('user_index') }}\">back to list</a>

    <a class=\"btn btn-warning\"  href=\"{{ path('user_edit', {'id': user.id}) }}\">edit</a><br/>
    <br/>

    {{ include('user/_delete_form.html.twig') }}
   </div> 
{% endblock %}
", "user/show.html.twig", "C:\\xampp\\Medical\\templates\\user\\show.html.twig");
    }
}
